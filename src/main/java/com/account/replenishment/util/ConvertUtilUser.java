 ...
 */
@Component
public class ConvertUtilUser {
    public User convertUserDTOToUser(UserDTO userDTO) {
        User user = new User();
        user.setIdUser(userDTO.getIdUser());
        user.setIdAdmin(userDTO.getIdAdmin());
        ...
        user.setJournalListAdmin(userDTO.getJournalListAdmin());
    ...
    public UserDTO convertUserToUserDTO(User user) {
        ...
        userDTO.setIdAdmin(user.getIdAdmin());
        ...
        userDTO.setJournalListAdmin(user.getJournalListAdmin());
